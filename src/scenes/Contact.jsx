        ...
        <section id="contact" className="py-48">
            ...
            <div className="md:flex md:justify-between gap-16 mt-5">
                ...
                >
                    ...
                    action="https://formsubmit.co/3e90b28da3d36af098d2219ce3eb2be8" 
                    method="POST"
                    >
                        ...
                        <button type="submit" className="p-5 bg-yellow font-semibold text-deep-blue mt-5 hover:bg-red"> SEND ME A MESSAGE </button>
                    </form>
                </motion.div>
            </div>
        </section>
